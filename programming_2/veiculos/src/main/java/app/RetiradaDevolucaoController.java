...
public class RetiradaDevolucaoController {

  @FXML
  private ComboBox<UsoVeiculo> withdraws;

  private ObservableList<UsoVeiculo> getWithdrawsObservable;

  private List<UsoVeiculo> getWithdraws;
  ...
  private void withdrawDevolution() {
    UsoVeiculo withdraw = withdraws.getSelectionModel().getSelectedItem();
